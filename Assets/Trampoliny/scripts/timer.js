...
function total(){
	...
	PlayerPrefs.SetInt("GamePoints_Strawberry",score_count.score_total);
	}
	...
	PlayerPrefs.SetInt("GamePoints_Peach",score_count.score_total);
	}
	...
	PlayerPrefs.SetInt("GamePoints_Blackberry",score_count.score_total);
	}
	...
	PlayerPrefs.SetInt("GamePoints_Raspberry",score_count.score_total);
	}
	...
	PlayerPrefs.SetInt("GamePoints_Blueberry",score_count.score_total);
	}
}